...
namespace EXPEDIT.Share.Helpers
{
    public class CaptchaHelper
    {
        ...
        public CaptchaHelper( int width, int height, System.Drawing.FontFamily fontFamily )
        {
            this.width = width;
            this.height = height;
            this.fontFamily = fontFamily;
        }
        public CaptchaHelper(string s, int width, int height, System.Drawing.FontFamily fontFamily)
        {
            this.text = s;
            this.width = width;
            this.height = height;
