(function () {
    ...
    // RENDER FOR - LIVE FORM

    // Dependent on /tiny-mce-custom-render-helper.js

    // Template to convert JSON to html form...
    window.renderLiveFunction['tiny-live-form'] = function (selected) {
        var formData = JSON.parse(decodeURIComponent(selected.data('json')));
        var formID = 'l-frm-' + formData.id;
        ...
        $form.append($('<div>').attr({
            class: 'btn btn-primary tiny-live-form-submit'
        }).html('submit'))
    ...
    window.renderLiveFunction['tiny-live-form-trigger'] = function (selected) {
        ...
        selected.find('.tiny-form-live-submit').click(function (e) {
            var $this = $(this);
    ...
    window.renderLiveFunction['tiny-live-form-editor'] = function (e) {
