                    ...
                    onClosed: function() {
                        ...
                        for (var i = 0; i < selectedData.length; i++) {
                            ...
                            var div = $('<div>').attr({
                                ...
                                'class': 'dirty tiny tiny-img mceNonEditable disable-user-select',
                                'type': 'tiny-img'
                            });
                        ...
                        tinyMCE.execCommand('mceReplaceContent', false, "&nbsp;<br/>" + newContent[0].get(0).outerHTML + "<br/>&nbsp;");
