(function () {
    ...
    window.renderFunction['tiny-form'] = function (selected) {
        ...
        var template = Handlebars.compile(source);
        var htmlTabs = template({ outlet: form, id: formID });
    ...
    window.renderFunction['tiny-form-trigger'] = function (selected) {
        selected.find('.nav-tabs a').click(function (e) {
            ...
            var a = $.ajax('http://test.miningappstore.com/share/user/forms/' + id.substring(4))
            ...
            a.success(function (a) {
                ...
                txt += "}";
                var y = Enumerable.From(a).Select(function (f) { var r = {}; var g = JSON.parse(f.FormData); $(g).each(function (i, z) { r[z.name] = z.value }); return r; }).ToArray();
