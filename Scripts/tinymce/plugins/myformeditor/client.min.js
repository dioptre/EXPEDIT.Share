    ...
    window.renderFunction['tiny-form-trigger'] = function (selected) {
        selected.find('.nav-tabs a').click(function (e) {
            ...
            a.success(function (a) {
                ...
                txt += "}";
                var y = Enumerable.From(a).Select(function (f) { var r = {}; var g = JSON.parse(f.FormData); $(g).each(function (i, z) { r[z.name] = z.value }); r['Updated'] = f.Updated; r['UpdatedBy'] = f.UpdatedBy; return r; }).ToArray();
